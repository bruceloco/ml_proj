...
In this case, I decided to use random forests. I have tried PCA, and although the accuracy was quite good, together with the processing time, I prefer to use random forest for their robustness and resistance to correlation.
